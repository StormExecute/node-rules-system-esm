import isObject from "../dependencies/isObject.mjs";

import getCallerPaths from "./getCallerPaths.mjs";

import settings from "./_settings/store.mjs";
...
export default function make(password, needToSetPassword, wrongPass) {
